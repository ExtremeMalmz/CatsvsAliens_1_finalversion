...
from Levels.level11 import level_11_game_loop
...
def level_10_game_loop():
    ...
    game_map = load_map(os.path.join('levels', 'level10'))

    block4_image = pygame.image.load(os.path.join('Assets', 'block4.jpeg'))
    ...
    while True: 
        ...
        pygame.draw.rect(display,(64, 64, 64),pygame.Rect(0,120,300,80))
        for background_object in background_objects:
            obj_rect = pygame.Rect(background_object[1][0]-scroll[0]*background_object[0],background_object[1][1]-scroll[1]*background_object[0],background_object[1][2],background_object[1][3])
            if background_object[0] == 0.5:
                pygame.draw.rect(display,(246,250,247),obj_rect)
            else:
                pygame.draw.rect(display,(213, 213, 214),obj_rect)
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(block4_image,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
