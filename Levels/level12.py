...
from Levels.level13 import level_13_game_loop
...
def level_12_game_loop():
    ...
    pygame.display.set_caption('Level 13')

    game_map = load_map(os.path.join('levels', 'level12'))

    stone1_image = pygame.image.load(os.path.join('Assets', 'stone1.jpeg'))
    ...
    while True: 
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(stone1_image,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
