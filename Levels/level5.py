...
from Levels.level6 import level_6_game_loop
...
def level_5_game_loop():
    ...
    game_map = load_map(os.path.join('levels', 'level5'))

    snow5_img = pygame.image.load(os.path.join('Assets', 'snow5.jpeg'))
    whitesnow_img = pygame.image.load(os.path.join('Assets','whitesnow.jpeg'))
    flag_image = pygame.image.load(os.path.join('Assets','flag.tiff'))
    blo_image = pygame.image.load(os.path.join('Assets','blo.jpeg'))
    snowrock_image = pygame.image.load(os.path.join('Assets','snowrock.png'))
    snowd_image = pygame.image.load(os.path.join('Assets','snowd.png'))
    ...
    while True: 
        ...
        for background_object in background_objects:
            ...
            if background_object[0] == 0.5:
                pygame.draw.rect(display,(210,240,250),obj_rect)
            else:
                pygame.draw.rect(display,(145,209,95),obj_rect)
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(snow5_img,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
                    display.blit(whitesnow_img,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '3':
                    display.blit(flag_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '4':
                    display.blit(blo_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '5':
                   display.blit(snow5_img, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '6':
                    display.blit(snowrock_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '7':
                    display.blit(snowd_image, (x * 16-scroll[0], y * 16-scroll[1]))    
                if tile != '0':
        ...
        if player_rect.x >= 1552 and player_rect.y == 64:
            send_to_level_6()
