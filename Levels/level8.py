...
def level_8_game_loop():
    ...
    game_map = load_map(os.path.join('levels', 'level8'))

    istockphoto_image = pygame.image.load(os.path.join('Assets', 'istockphoto.jpeg'))
    jelly_image = pygame.image.load(os.path.join('Assets','jelly.png'))
    flag_image = pygame.image.load(os.path.join('Assets','flag.tiff'))
    blocks1_image = pygame.image.load(os.path.join('Assets','blocks1.png'))
    snowrock_image = pygame.image.load(os.path.join('Assets','snowrock.png'))
    tree2_image = pygame.image.load(os.path.join('Assets','tree2.png'))
    ...
    while True: 
        ...
        for background_object in background_objects:
            ...
            if background_object[0] == 0.5:
                pygame.draw.rect(display,(26,22,2),obj_rect)
            else:
                pygame.draw.rect(display,(212, 224, 224),obj_rect)
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(istockphoto_image,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
                    display.blit(jelly_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '3':
                    display.blit(flag_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '4':
                    display.blit(blocks1_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '5':
                    display.blit(istockphoto_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '6':
                    display.blit(snowrock_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '7':
                    display.blit(tree2_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile != '0':
        ...
        if player_rect.x >= 1552 and player_rect.y == 0:
           send_to_level_9()
