...
def send_to_second_boss_fight():
    '''
    Sends the player to second boss fight
    '''
...
def level_18_game_loop():
    ...
    pygame.display.set_caption('Level 19')

    game_map = load_map(os.path.join('levels', 'level18'))

    stone10_image = pygame.image.load(os.path.join('Assets', 'stone10.png'))
    ...
    snowytree1_image = pygame.image.load(os.path.join('Assets','snowytree1.png'))
    ...
    while True: # game loop
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(stone10_image,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
                ...
                if tile == '7':
                    display.blit(snowytree1_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile != '0':
        ...
        if player_rect.x >= 1552 and player_rect.y == 16:
            send_to_second_boss_fight()
