...
from Levels.level8 import level_8_game_loop
...
def level_7_game_loop():
    ...
    game_map = load_map(os.path.join('levels', 'level7'))

    block2_image = pygame.image.load(os.path.join('Assets', 'block2.jpeg'))
    ...
    while True: 
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(block2_image,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
