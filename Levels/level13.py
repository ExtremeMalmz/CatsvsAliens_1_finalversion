...
from Levels.level14 import level_14_game_loop
...
def level_13_game_loop():
    ...
    pygame.display.set_caption('Level 14')

    game_map = load_map(os.path.join('levels', 'level13'))

    stone2_image = pygame.image.load(os.path.join('Assets', 'stone2.jpeg'))
    ...
    tree7_image = pygame.image.load(os.path.join('Assets','tree7.png'))
    ...
    while True: 
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(stone2_image,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
                ...
                if tile == '7':
                    display.blit(tree7_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile != '0':
