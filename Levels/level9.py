...
def level_9_game_loop():
    ...
    snowblock_image = pygame.image.load(os.path.join('Assets', 'snowblock.png'))
    ...
    while True: 
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(snowblock_image,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
                ...
                if tile == '7':
                    display.blit(tree4_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile != '0':
