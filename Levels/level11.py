...
from Levels.level12 import level_12_game_loop
...
def level_11_game_loop():
    ...
    game_map = load_map(os.path.join('levels', 'level11'))

    grass3_image = pygame.image.load(os.path.join('Assets', 'grass3.png'))
    ...
    grass5_image = pygame.image.load(os.path.join('Assets','grass5.jpeg'))
    ...
    while True: 
        ...
        for background_object in background_objects:
            ...
            if background_object[0] == 0.5:
                pygame.draw.rect(display,(89,190,55),obj_rect)
            else:
                pygame.draw.rect(display,(56, 65, 49),obj_rect)
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(grass3_image,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
                ...
                if tile == '7':
                    display.blit(grass5_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile != '0':
        ...
        if player_rect.x >= 1520 and player_rect.y == 16:
           send_to_level_12()
