...
from Levels.level16 import level_16_game_loop
...
def level_15_game_loop():
    ...
    pygame.display.set_caption('Level 16')

    game_map = load_map(os.path.join('levels', 'level15'))

    stone5_image = pygame.image.load(os.path.join('Assets', 'stone5.jpeg'))
    ...
    while True: 
        ...
        pygame.draw.rect(display,(91, 235, 235),pygame.Rect(0,120,300,80))
        for background_object in background_objects:
            obj_rect = pygame.Rect(background_object[1][0]-scroll[0]*background_object[0],background_object[1][1]-scroll[1]*background_object[0],background_object[1][2],background_object[1][3])
            if background_object[0] == 0.5:
                pygame.draw.rect(display,(160,165,164),obj_rect)
            else:
                pygame.draw.rect(display,(242, 235, 230),obj_rect)
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(stone5_image,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
