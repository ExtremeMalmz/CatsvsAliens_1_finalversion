...
from Levels.level7 import level_7_game_loop
...
def level_6_game_loop():
    ...
    game_map = load_map(os.path.join('levels', 'level6'))

    golden1_image = pygame.image.load(os.path.join('Assets', 'golden1.jpeg'))
    whitesnow1_image = pygame.image.load(os.path.join('Assets','whitesnow1.jpeg'))
    ...
    block1_image= pygame.image.load(os.path.join('Assets','block1.jpeg'))
    ...
    while True: 
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(golden1_image,(x*16-scroll[0],y*16-scroll[1]))
                if tile == '2':
                    display.blit(whitesnow1_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '3':
                ...
                if tile == '5':
                    display.blit(golden1_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '6':
                    display.blit(block1_image (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '7':
